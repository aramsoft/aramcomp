...
NSERT INTO COMTE_COPSEQ ( TABLE_NAME, NEXT_ID ) VALUES ('MTG_ID', 1);
...
(
  	...
  	TRNSMIS_CONFIRM_DT      datetime        NULL,
...
CREATE TABLE HYBTN_VIBRATOR
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	TIMESTAMP             	varchar(20)  	NULL,
	CONSTRAINT  HYBTN_VIBRATOR_PK PRIMARY KEY (SN, UUID)
);

CREATE TABLE HYBTN_ACCELERATOR
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	XAXIS                 	varchar(20)  	NULL,
	...
	TIMESTAMP             	varchar(20)  	NULL,
	USEYN                 	char(1)  		NULL,
	CONSTRAINT  HYBTN_ACCELERATOR_PK PRIMARY KEY (SN, UUID)
);

CREATE TABLE HYBTN_CONTACT_INFO
(
	ID                    	char(20)  		NOT NULL,
	NAME                  	char(60)  		NULL,
	TELNO                 	char(20)  		NULL,
	...
	USEYN                 	char(1)  		NULL,
	UUID                  	varchar(50)  	NOT NULL,
	CONSTRAINT  HYBTN_CONTACT_INFO_PK PRIMARY KEY (UUID, ID)
);

CREATE TABLE HYBTN_ADDRESS_INFO
(
	ID                    	char(20)  		NOT NULL,
	NAME                  	char(60)  		NULL,
	TELNO                 	char(20)  		NULL,
	...
	USEYN                 	char(1)  		NULL,
	UUID                  	varchar(50)  	NOT NULL,
	CONSTRAINT  HYBTN_ADDRESS_INFO_PK PRIMARY KEY (UUID, ID)
);

CREATE TABLE HYBTN_FILE_DETAIL_INFO
(
	FILE_SN               	decimal(20)  	NOT NULL,
	...
	CONSTRAINT  HYBTN_FILE_DETAIL_INFO_PK PRIMARY KEY (FILE_SN)
);

CREATE TABLE HYBTN_FILE_READER_WRITE
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	...
	CONSTRAINT  HYBTN_FILE_READER_WRITE_PK PRIMARY KEY (SN, UUID),
	CONSTRAINT  HYBTN_FILE_READER_WRITE_FK1 FOREIGN KEY (FILE_SN) REFERENCES HYBTN_FILE_DETAIL_INFO(FILE_SN) ON DELETE CASCADE
);

CREATE TABLE HYBTN_MEDIA
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	...
	FILE_SN               	decimal(20)  	NOT NULL,
	CONSTRAINT  HYBTN_MEDIA_PK PRIMARY KEY (SN, UUID),
	CONSTRAINT  HYBTN_MEDIA_FK1 FOREIGN KEY (FILE_SN) REFERENCES HYBTN_FILE_DETAIL_INFO(FILE_SN) ON DELETE CASCADE
);

CREATE TABLE HYBTN_DEVICE
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	...
	USEYN                 	char(1)  		NULL,
	OS                  	varchar(15)  	NULL,
	CONSTRAINT  HYBTN_DEVICE_PK PRIMARY KEY (SN, UUID)
);

CREATE TABLE HYBTN_INTERFACE_EGOV
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	EMAILS                	varchar(50)  	NULL,
	...
	CONSTRAINT  HYBTN_INTERFACE_EGOV_PK PRIMARY KEY (SN, UUID)
);

CREATE TABLE HYBTN_COMPASS
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	DRC                   	varchar(40)  	NULL,
	...
	USEYN                 	char(1)  		NULL,
	TIMESTAMP             	varchar(20)  	NULL,
	CONSTRAINT  HYBTN_COMPASS_PK PRIMARY KEY (SN, UUID)
);

CREATE TABLE HYBTN_GPS
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL, 
	LA                    	varchar(48)  	NULL,
	...
	USEYN                 	char(1)  		NULL,
	CONSTRAINT  HYBTN_GPS_PK PRIMARY KEY (SN, UUID)
);

CREATE TABLE HYBTN_CAMERA
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	...
	USEYN                 	char(1)  		NULL,
	FILE_SN               	decimal(20)  	NOT NULL,
	CONSTRAINT  HYBTN_CAMERA_PK PRIMARY KEY (SN, UUID),
	CONSTRAINT  HYBTN_CAMERA_FK1 FOREIGN KEY (FILE_SN) REFERENCES HYBTN_FILE_DETAIL_INFO(FILE_SN) ON DELETE CASCADE
);

CREATE TABLE HYBTN_NETWORK
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	NTWRK_TYPE            	varchar(20)  	NULL,
	USEYN                 	char(1)  		NULL,
	CONSTRAINT  HYBTN_NETWORK_PK PRIMARY KEY (SN, UUID)
);

CREATE TABLE HYBTN_PKI
(
	SN                    	decimal(6)  	NOT NULL,
	UUID                  	varchar(50)  	NOT NULL,
	...
	DN                    	varchar(255)  	NULL,
	CONSTRAINT  HYBTN_PKI_PK PRIMARY KEY (SN, UUID)
);
