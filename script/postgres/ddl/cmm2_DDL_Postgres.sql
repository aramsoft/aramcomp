...
COMMENT ON TABLE COMTE_COPSEQ IS 'COMTECOPSEQ'; 
...
-- COMMENT ON COLUMN COMTN_EMPLYR_INFO.LOCK_AT IS '잠금여부';
-- COMMENT ON COLUMN COMTN_EMPLYR_INFO.LOCK_CNT IS '잠금회수';
-- COMMENT ON COLUMN COMTN_EMPLYR_INFO.LOCK_LAST_PNTTM IS '잠금최종시점';
------------------------------------------------
