...
public class UserInfController {
	...
	public String registCmmntyManager(
		...
		return WebUtil.redirectJsp(model, "/cop/com/listCmmntyUser.do");
	}
	 ...
	 * @param popFlag
	 */
	@RequestMapping("/cop/com/listClubUser.do")
	public String selectClubUserList(
			@ModelAttribute UserInfVO userInfVO, 
			@RequestParam(value="PopFlag", required=false) String popFlag,
			ModelMap model) {
		...
		model.addAttribute("resultList", userInfService.selectClubUserList(userInfVO));

		int totCnt = userInfService.selectClubUserListCnt(userInfVO);
		userInfVO.setTotalRecordCount(totCnt);
	 ...
	 * @param popFlag
	 */
	@RequestMapping("/cop/com/listClubOprtr.do")
	@Secured("ROLE_USER")
	public String selectClubOprtrList(
			@ModelAttribute UserInfVO userInfVO, 
			@RequestParam(value="PopFlag", required=false) String popFlag,
			ModelMap model) {
		...
		model.addAttribute("resultList", userInfService.selectClubOprtrList(userInfVO));

		int totCnt = userInfService.selectClubOprtrListCnt(userInfVO);
		userInfVO.setTotalRecordCount(totCnt);
		...
		if ("Y".equals(popFlag)) {
			...
			returnUrl = "aramframework/com/cop/com/ClbOprtrListPop";
		} else {
			returnUrl = WebUtil.adjustViewName("/cop/com/UserList");
		}
		return returnUrl;
	...
	@Secured("ROLE_USER")
	public String registClbOprtr(
			@ModelAttribute UserInfVO userInfVO, 
			@RequestParam(value="param_clbId", required=true)    String clbId,
			@RequestParam(value="param_emplyrId", required=true) String emplyrId,
			ModelMap model) {
		...
		clubUserVO.setLastUpdusrId(loginVO.getUniqId());
		clubUserVO.setClbId(clbId);
		clubUserVO.setEmplyrId(emplyrId);
		clubUserVO.setUseAt("Y");
		clubUserVO.setOprtrAt("Y");

		clubService.updateClubUserInf(clubUserVO);

		model.addAttribute("message", MessageHelper.getMessage("success.common.insert"));
		return WebUtil.redirectJsp(model, "/cop/com/listClubUser.do");
	}

	/**
	 * 동호회에 대한 운영진 탈퇴를 처리한다.
	 * 
	 * @param userInfVO
	 * @param clbId
	 * @param emplyrId
	 */
	@RequestMapping("/cop/com/deleteClbOprtr.do")
	@Secured("ROLE_USER")
	public String deleteClbOprtr(
			@ModelAttribute UserInfVO userInfVO, 
			@RequestParam(value="param_clbId", required=true)    String clbId,
			@RequestParam(value="param_emplyrId", required=true) String emplyrId,
			ModelMap model) {
	 ...
	 * @param emplyrId
	 */
	@RequestMapping("/cop/com/eraseClbUser.do")
	@Secured("ROLE_USER")
	public String eraseClbUser(
			@ModelAttribute UserInfVO userInfVO, 
			@RequestParam(value="param_clbId", required=true)    String clbId,
			@RequestParam(value="param_emplyrId", required=true) String emplyrId,
			ModelMap model) {
		...
		clubService.eraseClubUserInf(clubUserVO);
