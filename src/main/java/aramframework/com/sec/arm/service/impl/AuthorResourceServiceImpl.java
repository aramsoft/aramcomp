...
@Service("authorResourceService")
public class AuthorResourceServiceImpl extends EgovAbstractServiceImpl implements AuthorResourceService {

	@Resource(name = "authorResourceMapper")
