...
import aramframework.com.uss.olp.qrm.dao.QustnrRespondManageMapper;
...
public class QustnrRespondManageService extends EgovAbstractServiceImpl {
	...
	@Autowired
	private EgovIdGnrService qustnrRespondManageIdGnrService; 
	...
	public QustnrRespondManageVO selectQustnrRespondManageDetail(QustnrRespondManageVO qustnrRespondManageVO) {
		...
		// searchVO 이전 
		resultVo.setSearchVO(qustnrRespondManageVO.getSearchVO()); 
		return resultVo;
	}
	...
	public void insertQustnrRespondManage(QustnrRespondManageVO qustnrRespondManageVO) {
		try {
			qustnrRespondManageVO.setQestnrRespondId(qustnrRespondManageIdGnrService.getNextStringId());
