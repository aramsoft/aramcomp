...
public class FileMntrg extends Thread {
	...
	ArrayList<String> realOriginalList = new ArrayList<String>(); // 최초의 원본리스트
	ArrayList<String> originalList = new ArrayList<String>(); // 직전리스트는 주기적으로 직전목록정보로 갱신된다.
	ArrayList<String> currentList = new ArrayList<String>(); // 직전리스트와 비교할 현시점 리스트
	ArrayList<String> changedList = new ArrayList<String>(); // 직전리스트와 비교한 시점에 발생된 변경리스트
	ArrayList<String> totalChangedList = new ArrayList<String>(); // 최초리스트와 비교한 변경 리스트
	...
	protected FileMntrg(String filename, File logFile) {
		...
		// 1. 최초생성시 현재 디렉토리의 하위정보를 ArrayList에 보관한다. 
		// 보관정보 ==> 절대경로 + "," + 최종수정일시 + "," + 사이즈
	...
	protected void doOnChange(ArrayList<String> changedList) {
