...
public class XMLDoc {
	...
	// Log protected static final Log log = LogFactory.getLog(EgovXMLDoc.class);
	/**
	...
	public static boolean creatSchemaToClass(String xml, String ja) throws Exception {
		...
		Process p = null;
		String cmdStr = AramProperties.getPathProperty(Globals.SHELL_FILE_PATH, "SHELL." + Globals.OS_TYPE + ".compileSchema");
