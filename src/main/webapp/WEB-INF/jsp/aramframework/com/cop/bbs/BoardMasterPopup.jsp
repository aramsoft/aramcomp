...
<tbody>
	...
	<tr>
 	...
 	<c:set var="searchVO" value="${boardMasterVO.searchVO}"/>
...
function fn_aram_choose(bbsId, bbsNm){
	if(window.opener.gArguments["bbsId"]) window.opener.gArguments["bbsId"].value = bbsId;
	if(window.opener.gArguments["bbsNm"]) window.opener.gArguments["bbsNm"].value = bbsNm;
	window.close();
}
