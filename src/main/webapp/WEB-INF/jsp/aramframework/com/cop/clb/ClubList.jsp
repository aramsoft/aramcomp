...
<table class="table-list"  summary="번호,동호회명,커뮤니티명,등록일,사용여부   목록입니다">
<thead>
	<tr>
...
function fn_aram_detail_club(clbId){
    var varForm = document.getElementById("clubVO");
...
function fn_aram_regist(){
    ...
    varForm.clbId.value = "";
    varForm.action = "${pageContext.request.contextPath}/cop/clb/registClub.do";
    varForm.submit();
}
