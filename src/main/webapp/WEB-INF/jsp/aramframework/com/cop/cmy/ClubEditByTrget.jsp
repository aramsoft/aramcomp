...
<%
 /**
  * @Class Name : ClubEditByTrget.jsp
  * @Description : 동호회 수정
...
<table class="table-register">
	...
	<tr>
	    ...
	    <td colspan="3">
	      	<form:input path="clbNm" size="60" maxlength="60" style="width:100%" title="동호회이름수정" />
...
function fn_aram_update() {
	...
	if (confirm("<spring:message code='common.update.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/cop/cmy/updateClubByTrget.do";
		varForm.submit();
	}
}
