...
<%
 /**
  * @Class Name : ClbOprtrListPop.jsp
  * @Description : 동호회 운영자 목록
...
<tbody>
	...
	<tr class="link" onClick="javascript:fn_aram_choose('<c:out value="${result.uniqId}" />');">
...
function fn_aram_choose(uniqId) {
    ...
    varForm.action = "${pageContext.request.contextPath}/cop/com/deleteClubUserBySelf.do";
    varForm.submit();
}
