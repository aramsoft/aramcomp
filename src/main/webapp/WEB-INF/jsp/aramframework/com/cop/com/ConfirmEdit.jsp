...
<form:form commandName="confirmHistoryVO" action ="" method="post">
...
<!-- 검색조건 유지 -->
<input type="hidden" name="searchCondition" value="${confirmHistoryVO.searchCondition}" />
<input type="hidden" name="searchKeyword"   value="${confirmHistoryVO.searchKeyword}" />
<input type="hidden" name="pageIndex"       value="${confirmHistoryVO.pageIndex}" />
<input type="hidden" name="recordPerPage"   value="${confirmHistoryVO.recordPerPage}" />
<!-- 검색조건 유지 -->
</form:form>
