...
<form:form commandName="nameCardVO" method="post">
<input type="hidden" name="curTrgetId" value="${curTrgetId}" />
<input type="hidden" name="curMenuNo" value="${curMenuNo}" />

<form:hidden path="ncrdId" />

<table class="table-register" summary="이름, 회사명, 직위, 부서명, 직급, 이메일주소, 전화번호, 휴대폰번호, 주소, 외부사용자여부, 공개여부, 비고 입니다">
	<tr> 
	    <th width="20%">
	...
	<tr> 
	    ...
	    <td width="30%">
	      	<form:input path="cmpnyNm" size="30" maxlength="60" title="" />
	    </td>
	    <th width="15%">
	    	<span class="norequired_icon"></span>
	    ...
	    <td width="35%">
	      	<form:input path="deptNm" size="30" maxlength="60" title="" />
	    </td>    
	</tr>
	<tr> 
	    <th>
	    ...
	    <td>
	      	<form:input path="ofcpsNm" size="30" maxlength="60" title="" />
	    </td>
	    <th>
	    	<span class="norequired_icon"></span>	    		
	    ...
	    <td>
	      	<form:input path="clsfNm" size="30" maxlength="60" title="" />
	    </td>    
	</tr>    
	<tr> 
	    <th>
	...
	<tr> 
	    ...
	    <td colspan="3">
	     	<form:select path="idntfcNo" class="select">
	  	   	...
	  	   	-
	      	<form:input path="middleMbtlNum" size="5" maxlength="4" />-
	      	<form:input path="endMbtlNum" size="5" maxlength="4" />
	    </td>
	</tr> 
	<tr> 
	    <th>
	...
	<tr>  
	    ...
	    <td colspan="3">
	     	<input type="radio" name="othbcScope" id="othbcScopeP" class="radio2" checked value="P"><label for="othbcScopeP">개인</label>&nbsp;
...
<!-- 검색조건 유지 -->
<input type="hidden" name="searchCondition" value="${nameCardVO.searchCondition}" />
<input type="hidden" name="searchKeyword"   value="${nameCardVO.searchKeyword}" />
<input type="hidden" name="pageIndex"       value="${nameCardVO.pageIndex}" />
<input type="hidden" name="recordPerPage"   value="${nameCardVO.recordPerPage}" />
<!-- 검색조건 유지 -->
</form:form>
...
function fn_aram_insert(){
	...
	if (confirm("<spring:message code='common.regist.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/cop/ncm/insertNameCard.do";
		varForm.submit();
	}
}
