...
<table class="table-list"  summary="이 표는 부서정보를 제공하며, 부서, 부서설명  정보로 구성되어 있습니다.">
...
function fn_aram_linkPage(pageNo) {
    ...
    varForm.action = "${pageContext.request.contextPath}/cop/smt/djm/listDept.do";
    varForm.submit();	
}
...
function fn_aram_choose(orgnztId, orgnztNm) {
	if( window.opener.gArguments["deptId"] ) window.opener.gArguments["deptId"].value = orgnztId;
	if( window.opener.gArguments["deptNm"] ) window.opener.gArguments["deptNm"].value = orgnztNm;
	window.close();
}
