...
<form:form commandName="diaryManageVO"  action="" method="post" enctype="multipart/form-data">
			...
			<tr>
				...
				<td>
					<a href="#" onClick="fn_aram_get_Schdule(); return false;">
						<img src="${pageContext.request.contextPath}/images/aramframework/com/cmm/icon/search.gif"  align="middle" style="border:0px" alt="일정정보" title="일정정보">
					</a>
				</td>
			</tr>
		</table>
...
<!-- 검색조건 유지 -->
<input type="hidden" name="searchCondition" value="${diaryManageVO.searchCondition}" />
<input type="hidden" name="searchKeyword"   value="${diaryManageVO.searchKeyword}" />
<input type="hidden" name="pageIndex"       value="${diaryManageVO.pageIndex}" />
<input type="hidden" name="recordPerPage"   value="${diaryManageVO.recordPerPage}" />
<!-- 검색조건 유지 -->
</form:form>
