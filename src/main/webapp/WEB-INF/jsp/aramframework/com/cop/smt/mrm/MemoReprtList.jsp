...
<tbody>
	...
	<tr>
 	...
 	<c:set var="startIndex" value="${(memoReprtVO.searchVO.pageIndex-1) * memoReprtVO.searchVO.recordPerPage}"/>
	<c:forEach var="result" items="${resultList}" varStatus="status">
	<tr class="link" onclick="javascript:fn_aram_detail('${result.reprtId}'); return false;">

 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${memoReprtVO.searchVO.totalRecordCount - index + 1}"/>
