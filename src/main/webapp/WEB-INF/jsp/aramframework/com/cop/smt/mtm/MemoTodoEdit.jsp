...
<table class="table-register"  summary="이 표는 메모할일 정보를  수정하기 위한 표이며, 할일일시, 작성자, 할일제목, 할일내용 정보로 구성되어 있습니다 .">
...
function fn_aram_update() {
	...
	if (confirm("<spring:message code='common.update.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/cop/smt/mtm/updateMemoTodo.do";
		varForm.submit();
	}
}
