...
<!-- 검색조건 유지 -->
<input type="hidden" name="searchCondition" value="${templateInfVO.searchCondition}" />
<input type="hidden" name="searchKeyword"   value="${templateInfVO.searchKeyword}" />
<input type="hidden" name="pageIndex"       value="${templateInfVO.pageIndex}" />
<input type="hidden" name="recordPerPage"   value="${templateInfVO.recordPerPage}" />
<!-- 검색조건 유지 -->
</form:form>
