...
<form:form commandName="resourceVO" action="" method="post">
...
<tbody>
	...
	<tr>
 	...
 	<c:set var="startIndex" value="${(resourceVO.searchVO.pageIndex-1) * resourceVO.searchVO.recordPerPage}"/>
 	<c:forEach var="result" items="${resultList}" varStatus="status">
  	<tr>
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${resourceVO.searchVO.totalRecordCount - index + 1}"/>
