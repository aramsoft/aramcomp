...
<%
 /**
  * @Class Name  : CntcServiceRegist.jsp
  * @Description : 연계서비스 등록
...
<form:form modelAttribute="cntcServiceVO" action="" method="post">
...
<!-- 등록  폼 영역  -->
<table class="table-register"  summary="연계서비스  입력을 제공한다.">
  	<tr>
    	<th width="20%">
  	...
  	<tr>
    	...
    	<td>
      		...
      		<form:errors path="svcId" cssClass="error"/>
    	</td>
  	</tr>
  	<tr>
    	<th>
...
function fn_aram_insert(){
	...
	if (confirm("<spring:message code='common.regist.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/ssi/syi/iis/insertCntcService.do";
		varForm.submit();
	}
}
