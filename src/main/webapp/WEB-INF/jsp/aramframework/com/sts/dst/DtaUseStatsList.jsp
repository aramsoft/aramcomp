   	...
   	<table class="table-list" border="0">
		...
		<tr>
		   	...
		   	<td width="350" height="10">
		  		<img src="${pageContext.request.contextPath}/images/aramframework/com/cmm/left_bg.gif" width="<c:out value='${resultInfo.grpCnt * dtaUseStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.grpCnt}&nbsp;개
			</td>
		</tr>
		</c:forEach>
