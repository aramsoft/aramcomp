...
<!-- 검색조건 유지 -->
<input type="hidden" name="searchCondition" value="${batchOpertVO.searchCondition}" />
<input type="hidden" name="searchKeyword"   value="${batchOpertVO.searchKeyword}" />
<input type="hidden" name="pageIndex"       value="${batchOpertVO.pageIndex}" />
<input type="hidden" name="recordPerPage"   value="${batchOpertVO.recordPerPage}" />
<!-- 검색조건 유지 -->
</form:form>
