...
<% 
/**
 * @Class Name : BatchSchdulEdit.jsp
 * @Description : 배치스케줄 수정
...
<caption>배치스케줄 수정</caption>
  	<tr>
    	...
    	<td width="80%">
        	<form:input path="batchSchdulId" size="20" maxlength="20" readonly="true"  />
  	...
  	<tr>
    	...
    	<td>
        	...
        	<a href="#" onClick="javascript:fn_aram_get_batchOpert(); return false;" style="selector-dummy: expression(this.hideFocus=false);">
        		<img src="${pageContext.request.contextPath}/images/aramframework/com/cmm/icon/search.gif" width="15" height="15" style="vertical-align: middle" alt="배치작업조회팝업 제공">
        	</a>
...
function fn_aram_update(){
	...
	if (confirm("<spring:message code='common.update.msg' />")) {
        varForm.action = "${pageContext.request.contextPath}/sym/bat/updateBatchSchdul.do";
        varForm.submit();
    }
}
