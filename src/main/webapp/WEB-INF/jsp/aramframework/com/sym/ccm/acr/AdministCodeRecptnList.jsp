...
<tbody>
	<c:if test="${fn:length(resultList) == 0}">
 	...
 	<c:set var="startIndex" value="${(administCodeRecptnVO.searchVO.pageIndex-1) * administCodeRecptnVO.searchVO.recordPerPage}"/>
	...
	<tr class="link" onclick="javascript:fn_aram_detail('<c:out value="${result.administZoneSe}"/>','<c:out value="${result.administZoneCode}"/>'); return false;">
		...
		<c:set var="reverseIndex" value="${administCodeRecptnVO.searchVO.totalRecordCount - index + 1}"/>
