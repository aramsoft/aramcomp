...
<%
 /**
  * @Class Name  : CmmnClCodeRegist.jsp
  * @Description : 공통분류코드 등록
...
<!-- 등록  폼 영역  -->
<form:form commandName="cmmnClCodeVO" action="" method="post">
...
<CAPTION>공통분류코드 등록</CAPTION>
  	<tr>
    	...
    	<td width="80%">
      		...
      		<form:errors path="clCode" cssClass="error"/>
    	</td>
  	</tr>
  	<tr>
    	<th>
...
<!-- 검색조건 유지 -->
<input type="hidden" name="searchCondition" value="${cmmnClCodeVO.searchCondition}" />
<input type="hidden" name="searchKeyword"   value="${cmmnClCodeVO.searchKeyword}" />
<input type="hidden" name="pageIndex"       value="${cmmnClCodeVO.pageIndex}" />
<input type="hidden" name="recordPerPage"   value="${cmmnClCodeVO.recordPerPage}" />
<!-- 검색조건 유지 -->
</form:form>
...
function fn_aram_insert(){
	...
	if (confirm("<spring:message code='common.regist.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/sym/ccm/ccc/insertCmmnClCode.do";
		varForm.submit();
	}
}
