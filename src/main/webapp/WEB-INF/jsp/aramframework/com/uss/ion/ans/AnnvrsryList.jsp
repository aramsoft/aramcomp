...
<tbody>
	...
	<tr> 
 	...
 	<c:set var="startIndex" value="${(annvrsryManageVO.searchVO.pageIndex-1) * annvrsryManageVO.searchVO.recordPerPage}"/>
 	<c:forEach var="result" items="${resultList}" varStatus="status">
  	<tr class="link" onclick="javascript:fn_aram_detail_annvrsryManage('${result.annId}'); return false;">
  	
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${annvrsryManageVO.searchVO.totalRecordCount - index + 1}"/>
