...
<tbody>
 	...
 	<c:set var="startIndex" value="${(bannerVO.searchVO.pageIndex-1) * bannerVO.searchVO.recordPerPage}"/>
   	<c:forEach var="result" items="${resultList}" varStatus="status">
  	<tr>
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${bannerVO.searchVO.totalRecordCount - index + 1}"/>
