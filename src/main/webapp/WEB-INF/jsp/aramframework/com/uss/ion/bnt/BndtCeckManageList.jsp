...
<tbody>
	...
	<tr> 
 	...
 	<c:set var="startIndex" value="${(bndtCeckManageVO.pageIndex-1) * bndtCeckManageVO.recordPerPage}"/>
	...
	<tr class="link" onclick="javascript:fn_aram_detail('<c:out value="${result.bndtCeckSe}"/>','<c:out value="${result.bndtCeckCd}"/>'); return false;">
		...
		<c:set var="reverseIndex" value="${bndtCeckManageVO.totalRecordCount - index + 1}"/>
