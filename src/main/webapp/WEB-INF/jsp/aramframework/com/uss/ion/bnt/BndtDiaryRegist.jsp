...
<%
/**
 * @Class Name : BndtDiaryRegist.jsp
 * @Description : 당직일지  등록
...
<!-- 등록  폼 영역  -->
<table class="table-list" summary="당직일지 등록">
...
<tbody>
	...
	<tr>
		...
		<c:if test="${result.bndtCeckSe != '99'}">
		<c:if test="${result.chckSttus == '1'}"></c:if>
...
function fn_aram_insert() {
	var varForm = document.getElementById("bndtDiaryVO");
   	...
   	varForm.diaryForInsert.value=valBndtDiary;

   	if(validatorCount!=0) return;
   	
	if(confirm("<spring:message code='common.regist.msg'/>")){
   		varForm.action = "${pageContext.request.contextPath}/uss/ion/bnt/insertBndtDiary.do";
  		varForm.submit();
	}	
}
