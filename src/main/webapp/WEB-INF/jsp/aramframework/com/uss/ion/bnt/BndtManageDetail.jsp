...
<%
/**
 * @Class Name : BndtManageDetail.java
 * @Description : 당직 상세조회
...
<!-- 등록  폼 영역  -->
<table class="table-detail" summary="당직 상세">
<caption>당직 상세</caption>
 	...
 	<tr> 
   		...
   		<td>
   			<textarea id="remark" name="remark" class="txArea" rows="4" cols="70" title="비고" readonly><c:out value='${bndtManageVO.remark}'/></textarea>
    	</td>    
  	</tr>     
</table>
...
function fn_aram_edit() {
	var varForm = document.getElementById("bndtManageVO");
	varForm.action = "${pageContext.request.contextPath}/uss/ion/bnt/editBndtManage.do";
	varForm.submit();   
}
...
function fn_aram_delete() {
	...
	if(confirm("<spring:message code='common.delete.msg'/>")){
	   	varForm.action = "${pageContext.request.contextPath}/uss/ion/bnt/deleteBndtManage.do";
       	varForm.submit();
   	}
}
