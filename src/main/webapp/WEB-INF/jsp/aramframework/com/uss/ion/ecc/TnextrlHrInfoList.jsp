...
<tbody>
	...
	<tr>
 	...
 	<c:set var="startIndex" value="${(tnextrlHrInfoVO.pageIndex-1) * tnextrlHrInfoVO.recordPerPage}"/>
 	<c:forEach items="${resultList}" var="result" varStatus="status">
    <tr class="link" onclick="javascript:fn_aram_detail('${result.extrlHrId}'); return false;">
    
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${tnextrlHrInfoVO.totalRecordCount - index + 1}"/>
