  	...
  	<tr>
    	...
    	<td width="80%">
      		...
      		<a href="#" onclick="fn_aram_EventCmpgnListPopup(); return false;">
      			<img src="${pageContext.request.contextPath}/images/aramframework/com/cmm/icon/search.gif" align="middle" style="border:0px" alt="행사/이벤트/캠페인 정보" title="행사/이벤트/캠페인 정보">
      		</a>
