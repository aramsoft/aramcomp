...
<tbody>
	...
	<tr> 
 	...
 	<c:set var="startIndex" value="${(eventManageVO.searchVO.pageIndex-1) * eventManageVO.searchVO.recordPerPage}"/>
	<c:forEach items="${resultList}" var="result" varStatus="status">
	<tr>
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${eventManageVO.searchVO.totalRecordCount - index + 1}"/>
