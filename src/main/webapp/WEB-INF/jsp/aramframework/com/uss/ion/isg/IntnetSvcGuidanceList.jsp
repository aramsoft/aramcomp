...
<tbody>
 	...
 	<c:set var="startIndex" value="${(intnetSvcGuidanceVO.searchVO.pageIndex-1) * intnetSvcGuidanceVO.searchVO.recordPerPage}"/>
 	<c:forEach var="result" items="${resultList}" varStatus="status">
 	<tr>
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${intnetSvcGuidanceVO.searchVO.totalRecordCount - index + 1}"/>
