...
<tbody>
 	...
 	<c:set var="startIndex" value="${(intnetSvcGuidanceVO.pageIndex-1) * intnetSvcGuidanceVO.recordPerPage}"/>
 	<c:forEach var="result" items="${resultList}" varStatus="status">
 	<tr>
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${intnetSvcGuidanceVO.totalRecordCount - index + 1}"/>
