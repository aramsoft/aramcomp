...
<tbody>
	...
	<tr>
 	...
 	<c:set var="startIndex" value="${(notificationVO.pageIndex-1) * notificationVO.recordPerPage}"/>
	<c:forEach var="result" items="${resultList}" varStatus="status">
	<tr class="link" onclick="javascript:fn_aram_detail('${result.ntfcNo}'); return false;">
 
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${notificationVO.totalRecordCount - index + 1}"/>
