...
<!-- 등록폼 시작  -->
<form:form commandName="noteManageVO" action="" method="post" enctype="multipart/form-data">
	   		...
	   		<div style="float:left;">
		   		<div style="float:left;padding:10px 10px 10px 30px;">
					...
					<a href="/uss/ion/ntm/listNoteEmpPopup.do" target="_blank" title="수신자/참조자 선택  팝업 새창으로" 
						...
						<img src="${pageContext.request.contextPath}/images/aramframework/com/cmm/icon/search.gif" alt="수신자찾기버튼" title="수신자찾기버튼">
					</a>
		   		</div>
