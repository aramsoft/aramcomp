...
<%
/**
 * @Class Name : IndndlpgeCntntsRegist.jsp
 * @Description : 마이페이지 컨텐츠 등록
...
<table class="table-register"  summary="마이페이지 컨텐츠 등록테이블">
  	<tr>
    	<th width="20%">
  	...
  	<tr>
    	...
    	<td>
      		&nbsp;
      		<input name="cntntsUseAt" id="cntntsUseAtY" type="radio" checked value="Y">
	      	Y
      		&nbsp;&nbsp;
      		<input name="cntntsUseAt" id="cntntsUseAtN" type="radio" value="N">
	      	N
...
<!-- 검색조건 유지 -->
<input type="hidden" name="searchCondition" value="${indvdlPgeCntntsVO.searchCondition}" />
<input type="hidden" name="searchKeyword"   value="${indvdlPgeCntntsVO.searchKeyword}" />
<input type="hidden" name="pageIndex"       value="${indvdlPgeCntntsVO.pageIndex}" />
<input type="hidden" name="recordPerPage"   value="${indvdlPgeCntntsVO.recordPerPage}" />
<!-- 검색조건 유지 -->
</form:form>
...
function fn_aram_insert() {
	...
	if(confirm("<spring:message code='common.regist.msg'/>")){
        varForm.action = "${pageContext.request.contextPath}/uss/mpe/insertIndvdlpgeCntnts.do";
        varForm.submit();
    }
}
