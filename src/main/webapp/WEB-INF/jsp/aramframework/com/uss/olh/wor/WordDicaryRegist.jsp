...
<%
 /**
  * @Class Name : WordDicaryRegist.jsp
  * @Description : 용어사전 등록
...
<table class="table-register" summary="용어사전에 대한 정보를 등록합니다.">
...
function fn_aram_insert(){
	...
	if(confirm("<spring:message code='common.regist.msg'/>")){
		varForm.action = "${pageContext.request.contextPath}/uss/olh/wor/insertWordDicary.do";
		varForm.submit();
	}
}
