...
<!-- 검색조건 유지 -->
<input type="hidden" name="searchCondition" value="${stplatManageVO.searchCondition}" />
<input type="hidden" name="searchKeyword"   value="${stplatManageVO.searchKeyword}" />
<input type="hidden" name="pageIndex"       value="${stplatManageVO.pageIndex}" />
<input type="hidden" name="recordPerPage"   value="${stplatManageVO.recordPerPage}" />
<!-- 검색조건 유지 -->
</form:form>
