...
<%
 /**
  * @Class Name : MberPassword.jsp
  * @Description : 일반회원 암호변경
...
<table class="table-register">
    <tr>
        ...
        <td width="80%">
            <form:input path="mberId" size="20" maxlength="20" readonly="true" />
...
function fn_aram_update(){
    ...
    if(validatePasswordChgVO(varForm)){
        ...
        varForm.action = "${pageContext.request.contextPath}/uss/umt/updateMberPassword.do";
        varForm.submit();
    }
}
