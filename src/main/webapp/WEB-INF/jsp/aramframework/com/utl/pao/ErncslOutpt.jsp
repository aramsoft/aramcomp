...
<%@ page import="aramframework.com.utl.pao.service.PrntngOutptService"  %>
...
<%
  ...
  */
%>
<link href="${pageContext.request.contextPath}/css/aramframework/com/cmm/utl/com.css" rel="stylesheet" type="text/css">
