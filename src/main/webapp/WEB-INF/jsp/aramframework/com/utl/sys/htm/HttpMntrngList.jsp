...
<tbody>					  										
	...
	<tr> 
 	...
 	<c:set var="startIndex" value="${(httpMntrngVO.searchVO.pageIndex-1) * httpMntrngVO.searchVO.recordPerPage}"/>
	<c:forEach items="${resultList}" var="result" varStatus="status">
	<tr class="link" onclick="javascript:fn_aram_detail('${result.sysId}'); return false;">	
	
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${httpMntrngVO.searchVO.totalRecordCount - index + 1}"/>
