...
<link rel="stylesheet" href="${pageContext.request.contextPath}/css/aramframework/com/cmm/button.css" type="text/css">
 ...
 <%
 	// 세션 정보를 가져온다. LoginVO 
           aramframework.com.uat.uia.domain.LoginVO user = (aramframework.com.uat.uia.domain.LoginVO)aramframework.com.cmm.userdetails.UserDetailsHelper.getAuthenticatedUser();
