...
<% 
/**
 * @Class Name : MmsAttachFileEdit.jsp
 * @Description : 첨부파일 수정
...
function fn_aram_updt_mmsAttachFile() {	
	...
	if (confirm("<spring:message code='common.update.msg' />"))    {  
	    document.atchFile.action = "${pageContext.request.contextPath}/mbl/com/mms/updateMmsAttachFile.mdo";
	    document.atchFile.submit();
	}
}

function fn_aram_delete_mmsAttachFile() {	
	document.atchFile.atchFileDelFlag.value = "Y";
	document.atchFile.action = "${pageContext.request.contextPath}/mbl/com/mms/goMmsAttachFileUpdt.mdo";
	document.atchFile.submit();
}
...
<div>
	...
	<div id="content" class="contents2">
		<form name="atchFile" method="post" action="" enctype="multipart/form-data">
			  	...
			  	<tr> 
				    ...
				    <td width="80%">
					    ...
					    <c:if test="${attachFile.atchFileId != ''}">
						   	...
						   	<input type="button" name="btnDelete" value="삭제" onClick="javascript:fn_aram_delete_mmsAttachFile();">
					    </c:if>
					    <c:if test="${attachFile.atchFileId == ''}">
			...
			<table border="0" cellspacing="0" cellpadding="0" align="center">
				<tr> 
					<td>
						<img src="${pageContext.request.contextPath}/images/egovframework/mbl/mcomd/button/bu2_left.gif" width="8" height="20" alt="수정버튼이미지">
					</td>
					<td background="${pageContext.request.contextPath}/images/egovframework/mbl/mcomd/button/bu2_bg.gif" class="text_left">
						<a href="JavaScript:fn_aram_updt_mmsAttachFile('<c:out value="${searchVO.sn}"/>');">수정</a>
					</td>
					<td>
						<img src="${pageContext.request.contextPath}/images/egovframework/mbl/mcomd/button/bu2_right.gif" width="8" height="20" alt="수정버튼이미지">
					</td>
					<td>&nbsp;</td>  
					<td>
					...
					<td background="${pageContext.request.contextPath}/images/egovframework/mbl/mcomd/button/bu2_bg.gif" class="text_left">
						<a href="javascript:fn_aram_select_mmsAttachFileList();">목록</a>
