...
<div>
	...
	<div id="content" class="contents">
		...
		<tbody>      
 			...
 			<c:set var="startIndex" value="${(offlineWebVO.searchVO.pageIndex-1) * offlineWebVO.searchVO.recordPerPage}"/>
			<c:forEach items="${resultList}" var="result" varStatus="status">
		  	<tr> 
		 		<c:set var="index" value="${startIndex + status.count}"/>
				<c:set var="reverseIndex" value="${offlineWebVO.searchVO.totalRecordCount - index + 1}"/>
