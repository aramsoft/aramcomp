...
<div id="regist" data-role="page" data-theme="d">
    ...
    <div data-role="header" data-theme="a" data-position="fixed">
		...
		<h1>동기화서비스 상세화면</h1>
		<a href="${pageContext.request.contextPath}/mbl/com/syn/listMobileSync.mdo" data-ajax="false" data-icon="back" class="ui-btn-right">이전</a>
	</div>
    <!-- header end -->
	...
	<div data-role="content" class="egov-mcomdContent">
		<!-- form -->
	 	<form:form commandName="syncVO" method="post">
		...
		<div class="ui-grid-b realBtn">
			...
			<div class="ui-block-b"><a href="${pageContext.request.contextPath}/mbl/com/syn/editMobileSync.mdo" data-ajax="false" data-role="button" data-theme="b">수정</a></div>			
