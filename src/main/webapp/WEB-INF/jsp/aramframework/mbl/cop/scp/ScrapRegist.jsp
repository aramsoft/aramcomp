...
<div id="regist" data-role="page" >
    ...
    <div data-role="content" class="com-copContent">
		...
		<form:form commandName="scrapVO" method="post" action="">
			<input type="hidden" name="bbsId" value="<c:out value='${boardVO.bbsId}'/>">
			<input type="hidden" name="nttId" value="<c:out value='${boardVO.nttId}'/>">
	
           	<dl class="com-addTxt">
           		<dt>스크랩명</dt>
           		<dd><form:input path="scrapNm" class="com-inpSubject" /></dd>
           	</dl>
		...
		<div class="com-addBgBtn">
			 <a href="javascript:fn_aram_insert();" data-role="button" data-theme="b" data-icon="check">등록</a>
		</div>  
...
function fn_aram_insert() {
	...
	varForm.action = "${pageContext.request.contextPath}/cop/scp/insertScrap.mdo";
	varForm.submit();			
}
