...
<div class="content_title">
	<h2><c:out value='${boardVO.boardMasterVO.bbsNm}'/> - 게시글 쓰기</h2>
</div>
...
<table class="table-register">
	<tr>
	    ...
	    <td>
	      	<form:input path="nttSj" size="60"  maxlength="60" title="제목입력" />
	      	<form:errors path="nttSj" cssClass="error"/>
	    </td>
	</tr>
	<tr>
	    <td colspan="2">
  			<textarea id="nttCn" name="nttCn" cols="75" rows="30" style="width:100%;"></textarea>
	...
	<tr>
	    ...
	    <td>
	      	<form:input path="ntcrNm" size="20" maxlength="10" title="작성자이름입력" />
	    </td>
	</tr>
	<tr>
	    <th>
	    ...
	    <td>
	      	<form:password path="password" size="20" maxlength="20" title="비밀번호입력" />
	    </td>
	</tr>
	</c:when>
	<c:otherwise>
...
function fn_aram_insert() {
	...
	if (confirm("<spring:message code='common.regist.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/cop/bbs/insertBoardArticle.do";
		varForm.submit();
	}
}
</c:if>
