...
<form:form modelAttribute="deptJobBxVO" method="post" action="">
			...
			<tr>
				...
				<td >
					<a href="#" target="_blank"  title="새 창으로 이동"  onClick="fn_aram_get_dept(); return false;">
						<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" style="border:0px" alt="부서" title="부서">
					</a>
				</td>
			</tr>
		</table>
