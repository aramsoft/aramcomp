  	...
  	<tr> 
		...
		<td>
			...
			<a href="#" title="새 창으로 이동"  onClick="fn_aram_get_deptJobBx(); return false;">
				<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" style="border:0px" alt="부서업무함" title="부서업무함">
			</a>
   	...
   	<tr> 
    	...
    	<td>
			...
			<a href="#" title="새 창으로 이동" onClick="fn_aram_get_charger('담당자', 'chargerId', 'chargerNm'); return false;">
				<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" style="border:0px" alt="담당자" title="담당자">
			</a>
...
function fn_aram_get_deptJobBx(){
	...
	var url = "/cop/smt/djm/listDeptJobBx.do?popFlag=Y&deptId="+varForm.deptId.value;
