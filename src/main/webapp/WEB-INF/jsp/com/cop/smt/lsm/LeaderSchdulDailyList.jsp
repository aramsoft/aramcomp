...
<div id="date_navigation" >
	...
	<div class="select_area" style="width:220px;" >
		...
		<a href="javascript:fn_aram_move_day('<%=iNowDay-1%>');">
			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icoPrev.gif" style="margin-right:4px;border:0px;" alt="이전일">
		</a>
		<% } %>
		<b><%=iNowDay%>일</b>
		<% if(iNowDay < iEndDay ){ %>
		<a href="javascript:fn_aram_move_day('<%=iNowDay+1%>');">
			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icoNxt.gif" style="margin-left:4px;border:0px;" alt="다음일">
		</a> 
		<% } %>
	</div>
</div>
