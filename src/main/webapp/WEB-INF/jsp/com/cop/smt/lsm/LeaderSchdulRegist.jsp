...
<% 
/**
 * @Class Name : LeaderSchdulRegist.jsp
 * @Description : 간부일정 등록
...
<table class="table-register" summary="이 표는 간부일정정보를 등록하기 위한 표이며, 일정구분, 간부, 일정명, 일정내용, 일정장소, 반복구분, 날짜/시간, 담당자 정보로 구성되어 있습니다 .">
...
<tbody>
	<tr>
	 ...
	 <tr>
	    ...
	    <td>
			...
			<a href="#" title="새 창으로 이동"  onClick="fn_aram_get_schdulCharger('간부', 'leaderId', 'leaderName'); return false;">
				<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" alt="간부선택 검색" >
			</a>
	...
	<tr>
	    ...
	    <td>
			...
			<a href="#" target="_blank"  title="새 창으로 이동"  onClick="fn_aram_get_schdulCharger('담당자', 'schdulChargerId', 'schdulChargerName'); return false;">
				<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" alt="담당자선택 검색" >
			</a>
...
function fn_aram_insert(){
	...
	if (confirm("<spring:message code='common.regist.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/cop/smt/lsm/insertLeaderSchdul.do";
		varForm.submit();
	}
}
