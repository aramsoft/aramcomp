...
<div id="date_navigation" >
	...
	<div class="select_area" style="width:200px;" >
		<a href="javascript:fn_aram_move_year('<%=iNowYear-1%>');">
			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icoPrev.gif" style="margin-right:4px;border:0px;" alt="이전년도">
		</a>
		<b><%=iNowYear%>년</b>
		<a href="javascript:fn_aram_move_year('<%=iNowYear+1%>');">
			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icoNxt.gif" style="margin-left:4px;border:0px;" alt="다음년도">
		</a>

		<% if(iNowMonth> 0 ){ %>
		<a href="javascript:fn_aram_move_month('<%=iNowMonth-1%>');">
			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icoPrev.gif" style="margin-right:4px;border:0px;" alt="이전월">
		</a>
		<% } %>
		<b><%=iNowMonth+1%>월</b>
		<% if(iNowMonth < 11 ){	%>
		<a href="javascript:fn_aram_move_month('<%=iNowMonth+1%>');">
			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icoNxt.gif" style="margin-left:4px;border:0px;" alt="다음월">
		</a> 
		<% } %>

		<% if(iNowWeek> 0 ){ %>
		<a href="javascript:fn_aram_move_week('<%=iNowWeek-1%>');">
			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icoPrev.gif" style="margin-right:4px;border:0px;" alt="이전주">
		</a>
		<% } %>
		<b><%=iNowWeek+1%>주</b>
		<% if(iNowWeek < listWeekGrop.size()-1 ){ %>
		<a href="javascript:fn_aram_move_week('<%=iNowWeek+1%>');">
			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icoNxt.gif" style="margin-left:4px;border:0px;" alt="다음주">
		</a> 
		<% } %>
	</div>
</div>
