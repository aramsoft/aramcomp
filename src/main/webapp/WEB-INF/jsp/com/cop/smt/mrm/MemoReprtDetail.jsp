...
<div id="search_area">
	<div class="search_right">
		<span class="button_area">
			<c:if test="${memoReprtVO.reportrId eq userId}">	
	    		<span class="button"><a href="#" onclick="javascript:fn_aram_opinion(); return false;">의견등록</a></span>
			</c:if>
			<c:if test="${memoReprtVO.reprtSttus eq '미확인' && memoReprtVO.wrterId eq userId}">	
...
<form:form modelAttribute="memoReprtVO" action="" method="post"> 
...
<tbody>
	...
	<!-- 첨부파일 테이블 레이아웃 -->
 	<tr>
		...
		<td>
			<c:import url="/files/${memoReprtVO.atchFileId}" />
		</td>
	</tr>
	<!-- //첨부파일 테이블 레이아웃 -->
	<tr> 
