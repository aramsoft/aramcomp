...
<tbody>
	...
	<tr>
	    ...
	    <td>
   			<textarea id="reprtCn" name="reprtCn" cols="75" rows="30"  style="width:100%;">
<c:out value="${memoReprtVO.reprtCn}" escapeXml="false" />
			</textarea>
	...
	<tr>
		...
		<td>
			...
			<c:import url="/files/${memoReprtVO.atchFileId}/edit" />
		</td>
	</tr>
	</c:when>
	<c:otherwise>
