...
<%
/**
 * @Class Name : MemoReprtRegist.jsp
 * @Description : 메모보고 등록
...
<form:form modelAttribute="memoReprtVO" action="" method="post" enctype="multipart/form-data"> 
...
<tbody>
			...
			<tr>
				...
				<td >
					<a href="#" title="새 창으로 이동"  onClick="fn_aram_get_reportr('보고대상', 'reportrId', 'reportrNm'); return false;">
						<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" style="border:0px" alt="보고대상 검색" title="보고대상 검색">
					</a>
				</td>
			</tr>
		</table>
	...
	<tr>
	    ...
	    <td>
  			<textarea id="reprtCn" name="reprtCn" cols="75" rows="30" style="width:100%;"></textarea>
...
function fn_aram_insert() {
	...
	if (confirm("<spring:message code='common.regist.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/cop/smt/mrm/insertMemoReprt.do";
		varForm.submit();
	}
}
...
function fn_aram_get_reportr(strTitle, empId, empName){
	...
	if( empName != "" )  gArguments["userNm"] = document.getElementById(empName);
