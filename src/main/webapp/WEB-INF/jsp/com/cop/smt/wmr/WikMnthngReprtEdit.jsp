...
<form:form modelAttribute="wikMnthngReprtVO" action="" method="post" enctype="multipart/form-data"> 
...
<tbody>
			...
			<tr>
				...
				<td >
					<a href="#" title="새 창으로 이동"  onClick="fn_aram_get_reportr('보고대상자', 'reportrId', 'reportrNm'); return false;">
						<img src="/images/com/cmm/icon/search.gif" style="border:0px" alt="보고대상자 검색" title="보고대상자 검색">
					</a>
				</td>
			</tr>
		</table>
	...
	<tr>
		...
		<td>
			...
			<c:import url="/files/${wikMnthngReprtVO.atchFileId}/edit" />
		</td>
	</tr>
	</c:when>
	<c:otherwise>
