...
<%
 /**
  * @Class Name  : MapTeamEdit.jsp
  * @Description : 지식맵(조직별) 수정
...
<form:form modelAttribute="mapTeamVO" method="post" action="">
...
<script type="text/javascript" src="/js/com/sym/cal/CalPopup.js"></script>
...
function fn_aram_update(){
	...
	if (confirm("<spring:message code='common.update.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/dam/map/tea/updateMapTeam.do";
		varForm.submit();
	}
}
