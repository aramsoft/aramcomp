...
<%
 /**
  * @Class Name  : SystemCntcRegist.jsp
  * @Description : 시스템연계 등록
...
<!-- 상단타이틀 -->
<form:form modelAttribute="systemCntcVO" action="" method="post">
...
<!-- 등록  폼 영역  -->
<table class="table-register" summary="시스템연계 입력을 제공한다.">
  	<tr>
    	<th width="20%">
    	...
    	<td width="80%">
      		<form:input  path="cntcId" title="연계ID" size="20" maxlength="20"  readonly="true" cssClass="readOnlyClass"/>
...
function fn_aram_insert(){
	...
	if (confirm("<spring:message code='common.regist.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/ssi/syi/sim/insertSystemCntc.do";
		varForm.submit();
	}
}
