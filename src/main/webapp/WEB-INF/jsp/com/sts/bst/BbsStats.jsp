...
<div class="content_title">
	...
	<a href="#" onclick="javascript:fn_aram_help(); return false;">
		<img src="${pageContext.request.contextPath}/images/com/cmm/icon/icon_help.gif" width="16" height="16" hspace="3" style="vertical-align:middle; display:inline-block;" alt="도움말아이콘이미지">
	</a>
</div>

<form:form modelAttribute="statsVO" action="${pageContext.request.contextPath}/sts/ust/selectBbsStats.do"  method="post">
		   	...
		   	<table class="table-list" border="0">
				...
				<tr>
				   	...
				   	<td width="350" height="10">
				  		<img src="${pageContext.request.contextPath}/images/com/cmm/left_bg.gif" width="<c:out value='${resultInfo.statsCo * statsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.statsCo}&nbsp;회
					</td>
				</tr>
				</c:forEach>
