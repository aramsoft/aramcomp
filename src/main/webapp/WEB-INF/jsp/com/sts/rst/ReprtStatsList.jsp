...
<form:form modelAttribute="reprtStatsVO" action="" method="post">
...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${reprtStatsVO.totalRecordCount} 건</strong>	
	</div>
   	...
   	<table class="table-list" border="0">
		...
		<tr>
		   	...
		   	<td width="350" height="10">
		  		<img src="${pageContext.request.contextPath}/images/com/cmm/left_bg.gif" width="<c:out value='${resultInfo.grpCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.grpCnt}&nbsp;개
			</td>
		</tr>
		</c:forEach>
...
<div style="width:80%; margin-bottom:20px;">
   	<table class="table-list" border="0">
		...
		<tr>
		   	...
		   	<td width="350" height="10">
		  		<img src="${pageContext.request.contextPath}/images/com/cmm/left_bg.gif" width="<c:out value='${resultInfo.grpReprtTyCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.grpReprtTyCnt}&nbsp;개
			</td>
		</tr>
		</c:forEach>
...
<div style="width:80%; margin-bottom:20px;">
   	<table class="table-list" border="0">
		...
		<tr>
		   	...
		   	<td width="350" height="10">
		  		<img src="${pageContext.request.contextPath}/images/com/cmm/left_bg.gif" width="<c:out value='${resultInfo.grpReprtSttusCnt * reprtStatsVO.maxUnit}' />" height="10" align="left" alt="">&nbsp;&nbsp;${resultInfo.grpReprtSttusCnt}&nbsp;개
			</td>
		</tr>
		</c:forEach>
