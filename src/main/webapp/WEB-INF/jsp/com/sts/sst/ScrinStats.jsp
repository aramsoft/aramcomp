...
<form:form modelAttribute="statsVO" action="${pageContext.request.contextPath}/sts/ust/selectScrinStats.do"  method="post">
...
<div style="width:40%; clear:both; float:right;">
	...
	<div class="tree" style="margin-left:50px; width:240px; height:500px; ">
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/com/sts/sst/treemenu.js"></script>
