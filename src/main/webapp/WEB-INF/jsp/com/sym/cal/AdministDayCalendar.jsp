...
<%
 /**
  * @Class Name  : AdministDayCalendar.jsp
  * @Description : 
...
<form name="administDayCalendar" action ="" method="post">
<input type="hidden" name="init" value="${init}" />

<div id="search_area">
	<div class="search_right">
		<span class="button_area">
	  		<select name="year" onChange="javascript:fn_aram_change_Calendar(document.administDayCalendar);" title="연도선택">
	  		...
	  		&nbsp;&nbsp;
	  		<select name="month" onChange="javascript:fn_aram_change_Calendar(document.administDayCalendar);" title="월선택">
	  		...
	  		&nbsp;&nbsp;
	  		<select name="day" onChange="javascript:fn_aram_change_Calendar(document.administDayCalendar);" title="일선택">
