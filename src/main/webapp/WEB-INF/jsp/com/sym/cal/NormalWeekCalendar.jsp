...
<%
 /**
  * @Class Name  : NormalWeekCalendar.jsp
  * @Description : 
...
<form name="normalWeekCalendar" action ="" method="post">
...
<div id="search_area">
	<div class="search_right">
		<span class="button_area">
	  		...
	  		&nbsp;&nbsp;
	  		<select name="month" onChange="javascript:fn_aram_change_Calendar(document.normalWeekCalendar);" title="월선택">
	  		...
	  		&nbsp;&nbsp;
	  		<select name="weeks" onChange="javascript:fn_aram_change_Calendar(document.normalWeekCalendar);" title="일선택">
