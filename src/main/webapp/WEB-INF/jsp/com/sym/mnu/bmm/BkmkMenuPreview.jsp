...
<table class="table-list" border="0">
    <tr>
    	<td width="10%">
		    <img src="${pageContext.request.contextPath}/images/com/cmm/utl/menu_base.gif" width="20" height="20" hspace="3" style="vertical-align: middle" alt = "base icon">
		</td>
	...
	<tr class="link" onclick="javascript:fn_aram_move('<c:url value="${result.progrmStrePath}"/>'); return false;">
		<td></td>
		<td>
		    <img src="${pageContext.request.contextPath}/images/com/cmm/utl/menu_page.gif" width="16" height="16" hspace="3" style="vertical-align: middle" alt = "menu_page icon">
		</td>
