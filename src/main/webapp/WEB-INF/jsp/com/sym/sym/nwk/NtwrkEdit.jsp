...
<form:form modelAttribute="ntwrkVO" action="" method="post">
<input type="hidden" name="curTrgetId" value="${curTrgetId}" />
<input type="hidden" name="curMenuNo" value="${curMenuNo}" />

<table class="table-register" summary="네트워크 정보를 수정한다.">
<caption>네트워크 등록</caption>
  	<tr>
    	...
    	<td width="80%">
    		<form:input path="ntwrkId" maxLength="30" size="30" readonly="true" />
    	</td>
  	</tr>
  	<tr>
    	<th>
...
function fn_aram_update() {
	...
	if(confirm("<spring:message code='common.update.msg'/>")){
        varForm.action = "${pageContext.request.contextPath}/sym/sym/nwk/updateNtwrk.do";
        varForm.submit();
    }
}
