...
<div id="date_navigation" >
	...
	<div class="select_area" style="width:200px;" >
		<a href="#" onClick="javascript:fn_aram_list_bndtManage('<%=year-1%>', '<%=month%>'); return false;"><img src="/images/com/cmm/icon/icoPrev.gif" alt="연도 이전" style="margin-right:4px;border:0px;"></a>
		<font size='3'><b><%=year%>년</b></font>
		<a href="#" onClick="javascript:fn_aram_list_bndtManage('<%=year+1%>', '<%=month%>'); return false;"><img src="/images/com/cmm/icon/icoNxt.gif"  alt="연도 이후" style="margin-left:4px;border:0px;"></a>

		<%if(month> 0 ){ %>
		<a href="#" onClick="javascript:fn_aram_list_bndtManage('<%=year%>', '<%=month-1%>'); return false;"><img src="/images/com/cmm/icon/icoPrev.gif" alt="월 이전" style="margin-right:4px;border:0px;"></a>
		<%}%>
		<font size='3'><b><%=month+1%>월</b></font>
		<%if(month < 11 ){ %>
		<a href="#" onClick="javascript:fn_aram_list_bndtManage('<%=year%>', '<%=month+1%>'); return false;"><img src="/images/com/cmm/icon/icoNxt.gif"  alt="월 이후" style="margin-left:4px;border:0px;"></a>
		<%}%>
	</div>
