...
<form:form modelAttribute="bndtManageVO" method="post" action="">
  	...
  	<tr>
    	...
    	<td width="80%">
			...
			<a href="/uss/ion/ism/listSanctnerPopup.do" target="_blank"  title="새 창으로 이동"  onClick="fn_aram_get_charger('당직 대상자', 'bndtId', '', 'bndtIdName', 'orgnztNm'); return false;">
				<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" style="border:0px" alt="당직" title="당직">
			</a>
