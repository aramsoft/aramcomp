...
<%
/**
 * @Class Name : LoginScrinImageEdit.jsp
 * @Description : 로그인화면이미지 수정
...
<form:form modelAttribute="loginScrinImageVO" method="post" action="" enctype="multipart/form-data"> 
<input type="hidden" name="curTrgetId" value="${curTrgetId}" />
<input type="hidden" name="curMenuNo" value="${curMenuNo}" />

<table class="table-register" summary="로그인화면이미지를 수정한다.">
<caption>로그인화면이미지 수정</caption>
  	<tr>
    	<th width="20%">
    		<span class="required_icon"></span>
    		<label for="imageId">이미지ID</label>
    	</th>
    	<td >
...
function fn_aram_update() {
	...
	if(confirm("<spring:message code='common.update.msg'/>")){
        varForm.action = "${pageContext.request.contextPath}/uss/ion/lsi/updateLoginScrinImage.do";
        varForm.submit();
    }
}
...
function fn_aram_delete() {
	...
	if(confirm("<spring:message code='common.delete.msg'/>")){
        varForm.action = "${pageContext.request.contextPath}/uss/ion/lsi/deleteLoginScrinImage.do";
        varForm.submit();
    }
}
