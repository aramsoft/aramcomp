...
<form:form modelAttribute="loginScrinImageVO" action="" method="post">
...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${loginScrinImageVO.totalRecordCount} 건</strong>	
	</div>
...
<tbody>
	...
	<tr>
 	...
 	<c:set var="searchVO" value="${loginScrinImageVO}"/>
