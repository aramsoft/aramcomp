...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${notificationVO.totalRecordCount} 건</strong>	
	</div>
...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/com/uss/ion/noi/Notification.js"></script>
