...
<%
 /**
  * @Class Name : RssManageRegist.jsp
  * @Description : RSS서비스관리 등록
...
<caption>RSS태그관리  입력폼 을 제공한다</caption>
	...
	<tr> 
		...
		<td>
	        <form:select path="trgetSvcTable" cssClass="txInput" onchange="fn_aram_tableColumn_rssManage();">
	...
	<tr> 
		...
		<caption>본문 Tag 정보 입력 제공한다</caption>
			<tr> 
				...
				<td width="80%">
					<a href="#" onClick="fn_aram_ColumnSetting('bdtTitle'); return false;"><img src="/images/com/cmm/btn/btn_regist.gif" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
					<form:input path="bdtTitle" size="50" title="본문TITLE" maxlength="255"/>
					<a href="#" onClick="document.getElementById('bdtTitle').value=''; return false;"><img src="/images/com/cmm/btn/btn_delete.gif" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
			...
			<tr> 
				...
				<td>
					<a href="#" onClick="fn_aram_ColumnSetting('bdtLink'); return false;"><img src="/images/com/cmm/btn/btn_regist.gif" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>	
					<form:input path="bdtLink" size="50" title="본문LINKE" maxlength="255"/>
					<a href="#" onClick="document.getElementById('bdtLink').value=''; return false;"><img src="/images/com/cmm/btn/btn_delete.gif" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
			...
			<tr> 
				...
				<td>
					<a href="#" onClick="fn_aram_ColumnSetting('bdtDescription'); return false;"><img src="/images/com/cmm/btn/btn_regist.gif" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
					<form:input path="bdtDescription" size="50" title="본문DESCRIPTION" maxlength="255"/>
					<a href="#" onClick="document.getElementById('bdtDescription').value=''; return false;"><img src="/images/com/cmm/btn/btn_delete.gif" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
			...
			<tr> 
				...
				<td>
					<a href="#" onClick="fn_aram_ColumnSetting('bdtTag'); return false;"><img src="/images/com/cmm/btn/btn_regist.gif" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 0px 0px 2px; " alt="컬럼명추가" title="컬럼명추가"></a>
					<form:input path="bdtTag" size="50" title="본문TAG"  maxlength="255"/>
					<a href="#" onClick="document.getElementById('bdtTag').value=''; return false;"><img src="/images/com/cmm/btn/btn_delete.gif" width="13px" height="14px" style="vertical-align:middle; display:inline-block;margin:0px 2px 0px 0px; " alt="컬럼명삭제" title="컬럼명삭제"></a>
					<form:errors path="bdtTag" cssClass="error"/>
				</td>
			</tr>
			<tr> 
				<th scope="row"  class="column_title">
 ...
 ******************************************************** */
 window.onload = function(){
	...
	//대상서비스목록갯수  초기화
	if( document.getElementById("trgetSvcListCo").value == "" 
			|| document.getElementById("trgetSvcListCo").value == "0"){
...
function fn_aram_insert(){
	...
	if(confirm("<spring:message code='common.regist.msg'/>")){
	    varForm.action = "${pageContext.request.contextPath}/uss/ion/rss/insertRssManage.do";
		varForm.submit();
	}
}
