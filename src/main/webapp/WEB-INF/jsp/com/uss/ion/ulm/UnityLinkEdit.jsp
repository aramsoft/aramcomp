...
<%
/**
 * @Class Name : UnityLinkEdit.jsp
 * @Description : 통합링크관리 수정
...
<form:form modelAttribute="unityLinkVO" method="post" action="" enctype="multipart/form-data">
...
<!--  등록  폼 영역  -->
<table class="table-register" summary="통합링크관리 수정을 제공한다.">
  	<tr>
    	<th width="20%">
...
function fn_aram_update(){
	...
	if(confirm("<spring:message code='common.update.msg'/>")){
		varForm.action =  "${pageContext.request.contextPath}/uss/ion/ulm/updateUnityLink.do";
		varForm.submit();
	}
}
