...
function fncNoonSeSpan(vValue){
    ...
    if(vValue != "02"){
		...
		vTemp += "  <img src='${pageContext.request.contextPath}/images/com/cmm/icon/bu_icon_carlendar.gif' onClick='javascript:fn_aram_NormalCalendar(document.forms[0].endde, document.forms[0].enddeView);' alt='달력' width='15' height='15'> ";
