...
<%
/**
 * @Class Name : AdministrationWordList.jsp
...
<form:form modelAttribute="administrationWordVO" action="" method="post">
...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${administrationWordVO.totalRecordCount} 건</strong>	
	</div>
	...
	<tr>
		...
		<table border="0">
			<tr>
				...
				<td <c:if test="${choseongA eq '하' && choseongB eq '힣'}">class="choseongTxt"</c:if>><a href="#" onClick="fn_aram_choseong('하', '힣', 'H'); return false;">ㅎ</a></td>
			</tr>
		</table>
		</td> 
...
function fn_aram_detail(administWordId){
    ...
    varForm.action = "${pageContext.request.contextPath}/uss/olh/awm/detailAdministrationWord.do";
    varForm.submit();
}
...
function fn_aram_regist(){
    var varForm = document.getElementById("administrationWordVO");
    varForm.administWordId.value ="";
    varForm.action = "${pageContext.request.contextPath}/uss/olh/awm/registAdministrationWord.do";
    varForm.submit();
}
