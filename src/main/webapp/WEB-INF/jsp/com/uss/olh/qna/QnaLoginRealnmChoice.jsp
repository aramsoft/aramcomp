...
<%
 /**
  * @Class Name : QnaLoginRealnmChoice.jsp
...
<div style="width:100%; text-align:center;">
	<div class="button_area">
		<span class="button"><a href="#" onclick="javascript:fn_aram_confirm_login(); return false;">로그인</a></span>
		<span class="button"><a href="#" onclick="javascript:fn_aram_confirm_realname(); return false;">실명확인</a></span>
		<span class="button"><a href="#" onclick="javascript:fn_aram_cancel_loginrealnm(); return false;">취소</a></span>
	</div>
</div>
