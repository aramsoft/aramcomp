...
<table class="table-register">
  	<tr>
    	...
    	<td width="80%">
     		<form:input path="mtgNm" size="73" maxlength="250" title="회의제목 입력" />
  	...
  	<tr>
    	...
    	<td>
      		<form:textarea path="mtgMtrCn" class="textarea"  cols="75" rows="4"  style="width:99%;" title="회의안건내용 입력" />
  	...
  	<tr>
    	...
    	<td>
      		<form:input path="mtgPlace" size="73" maxlength="250" style="width:200px;" title="회의장소 입력" />
  	...
  	<tr>
    	...
    	<td>
      		<form:textarea path="mtgResultCn" class="textarea"  cols="75" rows="4"  style="width:99%;" title="회의결과내용입력" />
    	</td>
  	</tr>
  	<tr>
    	<th>
    	...
    	<td>
     		<form:input path="mngtDeptNm" size="73" maxlength="2000" title="주관부서 입력" style="width:100px;" readonly="true" />
      		<a href="${pageContext.request.contextPath}/uss/olp/mgt/listMeetingDeptPopup.do" target="_blank" title="주관부서 선택  팝업 새창으로" onclick="fn_aram_get_mngtDeptNm();return false">
      			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" align="middle" style="border:0px" alt="주관부서 찾기버튼" title="주관부서 찾기버튼">
      		</a>
  	...
  	<tr>
    	...
    	<td>
      		...
      		<a href="${pageContext.request.contextPath}/uss/olp/mgt/listMeetingEmpLyrPopup.do" target="_blank" title="주관자ID 선택  팝업 새창으로" onclick="fn_aram_get_mnaer();return false">
      			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" align="middle" style="border:0px" alt="주관자ID 찾기버튼" title="주관자ID 찾기 버튼">
      		</a>
  	...
  	<tr>
    	...
    	<td>
      		...
      		<a href="${pageContext.request.contextPath}/uss/olp/mgt/listMeetingDeptPopup.do" target="_blank" title="주관자부서 선택  팝업 새창으로" onclick="fn_aram_get_mnaerDept();return false">
      			<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" align="middle" style="border:0px" alt="주관자부서 찾기버튼" title="주관자부서 찾기 버튼">
      		</a>
...
function fn_aram_insert(){
	...
	if(varForm.nonatdrnCo.value == ""){
		varForm.nonatdrnCo.value = "0";
	}
	if(varForm.atdrnCo.value == ""){
		varForm.atdrnCo.value = "0";
	}
	...
	if(confirm("<spring:message code='common.regist.msg'/>")){
		varForm.action =  "${pageContext.request.contextPath}/uss/olp/mgt/insertMeeting.do";
		varForm.submit();
	}
}
