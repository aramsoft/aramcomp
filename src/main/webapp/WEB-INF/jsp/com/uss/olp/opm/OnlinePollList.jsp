...
<form:form modelAttribute="onlinePollManageVO" action="" method="post">
...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${onlinePollManageVO.totalRecordCount} 건</strong>	
	</div>
...
<tbody>
	...
	<%-- 데이터를 화면에 출력해준다 --%>
 	<c:set var="searchVO" value="${onlinePollManageVO}"/>
