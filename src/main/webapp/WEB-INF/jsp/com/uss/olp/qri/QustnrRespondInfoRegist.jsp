...
<form:form modelAttribute="qustnrRespondInfoVO" action="" method="post">
    	...
    	<td width="80%">
			<form:input path="qestnrSj" title="설문관리정보 입력" size="73" maxlength="4000" style="width:300px;" />
     		<a href="#" onClick="fn_aram_get_qustnr(); return false;">
				<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" align="middle" style="border:0px" alt="설문관리정보" title="설문관리정보">
			</a>
    	</td>
  	</tr>
  	<tr>
    	...
    	<td>
    		...
    		<a href="#" onClick="fn_aram_get_qustnrQestn(); return false;">
				<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" align="middle" style="border:0px" alt="설문문항정보" title="설문문항정보">
			</a>
    	...
    	<td>
			<form:input path="qustnrIemCn" title="설문문항정보" size="73" maxlength="4000" style="width:300px;" />
         	<a href="#" onClick="fn_aram_get_qustnrItem(); return false;">
				<img src="${pageContext.request.contextPath}/images/com/cmm/icon/search.gif" align="middle" style="border:0px" alt="설문항목정보" title="새창">
			</a>
