...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${qustnrRespondInfoVO.totalRecordCount} 건</strong>	
	</div>
...
<tbody>
	...
	<tr>
	 ...
	 <%-- 데이터를 화면에 출력해준다 --%>
   	<c:set var="searchVO" value="${qustnrRespondInfoVO}"/>
 	<c:set var="startIndex" value="${(searchVO.pageIndex-1) * searchVO.recordPerPage}"/>
	<c:forEach items="${resultList}" var="result" varStatus="status">
	<tr>
 		<c:set var="index" value="${startIndex + status.count}"/>
		<c:set var="reverseIndex" value="${qustnrRespondInfoVO.searchVO.totalRecordCount - index + 1}"/>
