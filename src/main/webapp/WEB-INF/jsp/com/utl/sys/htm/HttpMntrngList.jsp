...
<form:form modelAttribute="httpMntrngVO" action="" method="post">
...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${httpMntrngVO.totalRecordCount} 건</strong>	
	</div>
...
<tbody>					  										
    ...
    <c:set var="searchVO" value="${httpMntrngVO}"/>
...
<script type="text/javascript" src="/js/com/cmm/utl/CmmUtl.js"></script>		
