...
<form:form modelAttribute="ntwrkSvcMntrngVO" action="" method="post">
...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${ntwrkSvcMntrngVO.totalRecordCount} 건</strong>	
	</div>
...
<tbody>
    ...
    <c:set var="searchVO" value="${ntwrkSvcMntrngVO}"/>
