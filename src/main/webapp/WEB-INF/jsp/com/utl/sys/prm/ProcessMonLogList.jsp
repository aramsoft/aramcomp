...
<form:form modelAttribute="processMonLogVO" action="" method="post">
...
<div id="search_area">
	<div class="search_left">
	 	<strong>전체 : ${processMonLogVO.totalRecordCount} 건</strong>	
	</div>
...
<tbody>
    ...
    <c:set var="searchVO" value="${processMonLogVO}"/>
