...
<%
 /**
  * @Class Name  : ProxySvcEdit.jsp
  * @Description : 프록시설정 수정
...
<form:form modelAttribute="proxySvcVO" method="post" action="">
<input type="hidden" name="curTrgetId" value="${curTrgetId}" />
<input type="hidden" name="curMenuNo" value="${curMenuNo}" />

<input type="hidden" name="strPreSvcSttus" value="<c:out value='${proxySvcVO.svcSttus}'/>" />

<table class="table-register" summary="프록시설정 정보를 수정한다.">
    ...
    <tr>
        ...
        <td>
        	<form:input path="proxyPort" imaxLength="10" size="10" />
...
function fn_aram_update() {
	...
	if(confirm("<spring:message code='common.update.msg'/>")){
        varForm.action = "${pageContext.request.contextPath}/utl/sys/pxy/updateProxySvc.do";
        varForm.submit();
    }
}
