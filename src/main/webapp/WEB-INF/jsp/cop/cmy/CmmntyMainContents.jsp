...
<div class="comun_board">
	...
	<div class="comun_board_more"> 
		<a href="#" onclick="javascript:fn_aram_loadArticleList('<c:out value="${board.bbsId}" />'); return false;"><img src="${pageContext.request.contextPath}/images/cop/tpl/more_08.gif" width="36" height="12" alt="더보기이미지아이콘" ></a>
	</div>
		...
		<table border="0">
			...
			<tr>
				<td height="22" align="left">
					<span class="right_board_date"><img src="${pageContext.request.contextPath}/images/cop/tpl/dot.gif" width="12" height="4" alt="도트이미지">[<fmt:formatDate value="${article.frstRegisterPnttm}" pattern="yyyy-MM-dd"/>]</span> 
	    		<c:choose>
