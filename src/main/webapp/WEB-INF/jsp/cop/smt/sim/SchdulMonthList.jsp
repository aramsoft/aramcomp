...
<div id="date_navigation" >
	...
	<div class="select_area" style="width:200px;" >
		<a href="javascript:fn_aram_move_year('<%=year-1%>');">
			<img src="${pageContext.request.contextPath}/images/cmm/icon/icoPrev.gif" style="margin-right:4px;border:0px;" alt="이전으로가기아이콘표시">
		</a>
		<%=year%>년
		<a href="javascript:fn_aram_move_year('<%=year+1%>');">
			<img src="${pageContext.request.contextPath}/images/cmm/icon/icoNxt.gif" style="margin-left:4px;border:0px;" alt="다음으로가기아이콘표시">
		</a>
