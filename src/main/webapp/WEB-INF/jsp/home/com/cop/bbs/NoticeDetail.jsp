...
function fn_aram_edit() {
	...
	varForm.action = "${pageContext.request.contextPath}/home/cop/bbs/editBoardArticle.do";
	varForm.submit();
}
...
function fn_aram_delete() {
	...
	if (confirm("<spring:message code='common.delete.msg' />")) {
		varForm.action = "${pageContext.request.contextPath}/home/cop/bbs/deleteBoardArticle.do";
		varForm.submit();
	}
}
...
function fn_aram_reply() {
    var varForm = document.getElementById("boardVO");
    varForm.action = "${pageContext.request.contextPath}/home/cop/bbs/replyBoardArticle.do";
    varForm.submit();
}
...
<c:import url="/home/listComment.do" charEncoding="utf-8">
    <c:param name="type" value="head" />
</c:import>
</c:if>
<c:if test="${useSatisfaction == 'true'}">
<c:import url="/home/listSatisfaction.do" charEncoding="utf-8">
    <c:param name="type" value="head" />
</c:import>
</c:if>
<!-- 2009.06.29 : 2단계 기능 추가  -->
