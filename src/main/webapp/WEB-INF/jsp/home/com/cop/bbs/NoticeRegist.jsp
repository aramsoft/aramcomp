                	...
                	<table>
                        <tr>
						    ...
						    <td width="80%"  colspan="3">
						        <form:input path="nttSj" size="60" value=""  maxlength="60" /> 
						        <form:errors path="nttSj" cssClass="error"/>
						    </td>
						</tr>
						<tr> 
						    <th><label for="nttCn">
						        <spring:message code="cop.nttCn" /></label>
                                <img src="${pageContext.request.contextPath}/images/home/required.gif" width="15" height="15" alt="required" />
                            </th>
						    <td colspan="3">
                    ...
                    <!-- 목록/저장버튼  -->
                 	<div class="buttons_center">
                		<c:if test="${editAuthFlag == 'Y'}">
          				...
          				<a href="#" onclick="javascript:fn_aram_list(); return fasle;"><spring:message code="button.list" /></a> 
					</div>
                </div>
                <!-- 버튼 끝 -->                           
            </form:form>
...
function fn_aram_insert() {
    ...
    if (confirm("<spring:message code='common.regist.msg' />")) {
        varForm.action = "${pageContext.request.contextPath}/home/cop/bbs/insertBoardArticle.do";
        varForm.submit();
    }
}
