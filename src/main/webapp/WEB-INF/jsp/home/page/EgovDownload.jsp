		...
		<div id="content">
				...
				<div class="download_loc">
					<div class="download_content_wrap">
						...
						<div class="download_text_loc">
							<ul>
								<li><a href="${pageContext.request.contextPath}/home/EgovDownloadDetail.do">egovframe installer v1.03</a></li>
			...
			<div class="default_tablestyle">
				...
				<tr>
					...
					<td class="align_left_text"><a href="${pageContext.request.contextPath}/home/EgovDownloadDetail.do">전자정부표준프레임워크 인스톨러(Egovframework installer) V1.037</a></td>
					<td>100</td>
					<td>16MB</td>
					<td>2011-04-04</td>
				</tr>
			...
			<!-- //페이지 네비게이션 끝 -->
			<div class="buttons"><a href="${pageContext.request.contextPath}/home/EgovDownloadModify.do">자료올리기 </a></div> 						
		</div>
