...
%>
        <div id="content">
			...
			<form:form commandName="boardUseInfVO" method="post">
                    ...
                    <table summary="게시판명, 커뮤니티 동호회 정보  입니다">
					    <tr>   
					        ...
					        <td width="70%"  colspan="3">
					          	...
					          	&nbsp;<a href="#" onclick="fn_aram_get_board(); return false;" style="selector-dummy: expression(this.hideFocus=false);"><img src="${pageContext.request.contextPath}/images/home/sample/img_search.gif"
