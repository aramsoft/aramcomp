...
function fn_aram_linkPage(pageNo) {
    ...
    varForm.action = "${pageContext.request.contextPath}/home/sample/content/board/"+bbsId+"/articles";
    varForm.submit();
}
...
function fn_aram_detail(nttId) {
    ...
    varForm.action = "${pageContext.request.contextPath}/home/sample/content/board/"+bbsId+"/article/" + nttId;
    varForm.submit();
}
...
function fn_aram_regist() {
    ...
    varForm.action = "${pageContext.request.contextPath}/home/sample/registBoardArticle.do";
    varForm.submit();
}
