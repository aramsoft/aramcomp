                    ...
                    <fieldset>
                        ...
                        <div class="sf_start">
							...
							<a href="javascript:fn_aram_move_week('<%=iNowWeek-1%>');">
				            	<img alt="이전주로 이동" src="${pageContext.request.contextPath}/images/home/sample/btn/btn_prev.gif" align="middle" style="margin-right:4px;border:0px;">
				            </a>
				            <%}%>
				            <%=iNowWeek+1%>주
				            <%if(iNowWeek < listWeekGrop.size()-1 ){ %>
							<a href="javascript:fn_aram_move_week('<%=iNowWeek+1%>');">
				            	<img alt="다음주로 이동" src="${pageContext.request.contextPath}/images/home/sample/btn/btn_next.gif" align="middle" style="margin-left:4px;border:0px;">
				            </a> 
				            <%}%>
                        </div>          
                    </fieldset>
