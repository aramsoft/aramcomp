...
<%@ page import="aramframework.com.cmm.util.UserDetailsHelper" %>
...
<ul>
	<li><a href="javascript:fn_main_headPageMove('10','EgovAboutSite.do')">사이트소개</a></li>
    <li><a href="javascript:fn_main_headPageMove('20','EgovProductInfo.do')">정보마당</a></li>
    <li><a href="javascript:fn_main_headPageMove('30','EgovDownload.do')">고객지원</a></li>
