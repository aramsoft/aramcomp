...
<div id="gnb">
	<div id="top_logo"><a href="${pageContext.request.contextPath}/sym/mnu/mpm/MainMenuHome.do" target="_top"><img src="${pageContext.request.contextPath}/images/aramframework/com/logo_01.gif" alt="egovframe" /></a></div>
	<div id="use_descri">
  		<ul>
      		<li>공통서비스 테스트 사이트(일반사용자용)</li>
            <li><a href="${pageContext.request.contextPath}/uat/uia/actionLogout.do?targetUrl=/sym/mnu/mpm/MainMenuHome.do"><img src="${pageContext.request.contextPath}/images/aramframework/com/logout_btn.gif" alt="로그아웃" /></a></li>
  		</ul>
	</div>
</div>
<div id="new_topnavi">
