...
<%
 /**
  * @Class Name  : AdministMonthCalendar.jsp
  * @Description : 
...
<form name="administMonthCalendar" action ="" method="post">
<input type="hidden" name="init" value="${init}" />
<input type="hidden" name="day" />

<div id="search_area">
	<div class="button_area">
	  		<select name="year" onChange="javascript:fn_aram_change_Calendar(document.administMonthCalendar);" title="연도선택">
	  		...
	  		&nbsp;&nbsp;
	  		<select name="month" onChange="javascript:fn_aram_change_Calendar(document.administMonthCalendar);" title="월선택">
...
function fnChangeCalendar(year, month){
	...
	varForm.action      = "${pageContext.request.contextPath}/sym/cal/AdministMonthCalendar.do";
