  	...
  	<tr>
    	...
    	<td>
      		...
      		<a href="#" target="_blank" title="새창으로" onClick="mvmnMenuList(); return false;"  style="selector-dummy:expression(this.hideFocus=false);">
      			<img src="${pageContext.request.contextPath}/images/cmm/icon/search.gif" alt='' width="15" height="15" />(메뉴선택 검색)
      		</a>
  	...
  	<tr>
    	...
    	<td colspan="3">
        	...
        	<a href="#" target="_blank" title="새창으로" onclick="javascript:searchFileNm(); return false;" style="selector-dummy:expression(this.hideFocus=false);">
        		<img src="${pageContext.request.contextPath}/images/cmm/icon/search.gif" alt='' width="15" height="15" />(프로그램파일명 검색)
        	</a>
...
function fn_aram_insert() {
	...
	if(confirm("<spring:message code='common.regist.msg'/>")){
		varForm.action="${pageContext.request.contextPath}/sym/mnu/mpm/insertMenu.do";
		varForm.submit();
	}
}
