...
<script type="text/javascript" src="${pageContext.request.contextPath}/js/sym/mnu/mpm/MenuList.js"></script>
...
<caption>메뉴리스트정보 </caption>
  	...
  	<tr>
    	...
    	<td width="70%">&nbsp;
    		<input name="upperMenuId" type="text" size="10" value=""  maxlength="10" title="상위메뉴No">
       		<a href="#" title="새창으로" onClick="mvmnMenuList();return false;"  style="selector-dummy:expression(this.hideFocus=false);"><img src="${pageContext.request.contextPath}/images/cmm/icon/search.gif"
  	...
  	<tr>
    	...
    	<td width="70%">
       		...
       		<a href="#" title="새창으로" onClick="searchFileNm();return false;"  style="selector-dummy:expression(this.hideFocus=false);"><img src="${pageContext.request.contextPath}/images/cmm/icon/search.gif"
