...
function fncSearchSpan(vSearch) {
	...
	if(vSearch == "1"){
        ...
        searchSpan.innerHTML += "요청일자&nbsp;"
            ...
            + " <a href=\"#\" onClick=\"javascript:fn_aram_NormalCalendar(document.forms[0].searchKeywordFrom,''); return false;\" style=\"selector-dummy:expression(this.hideFocus=false);\"><img src=\"${pageContext.request.contextPath}/images/cmm/icon/bu_icon_carlendar.gif\" name=\"cal_img1\" id=\"cal_img1\" border=\"0\" title=\"달력\" alt=\"달력\"><//a> ~ "
            + "<input name='searchKeywordTo'   type='text' size='8' value=''  maxlength='8'>"
            + " <a href=\"#\" onClick=\"javascript:fn_aram_NormalCalendar(document.forms[0].searchKeywordTo,''); return false;\" style=\"selector-dummy:expression(this.hideFocus=false);\"><img src=\"${pageContext.request.contextPath}/images/cmm/icon/bu_icon_carlendar.gif\" name=\"cal_img2\" id=\"cal_img2\" border=\"0\" title=\"달력\" alt=\"달력\"><//a>";
	}else if(vSearch == "4"){
