...
<%
 /**
  * @Class Name : BackupOpertRegist.jsp
  * @Description : 백업작업 등록
...
<caption>백업작업 등록</caption>
   ...
   -->
  	<tr>
    	...
    	<td>
        	<form:input path="backupOpertNm" size="30" maxlength="60" />
  	...
  	<tr>
    	...
    	<td>
        	<form:input path="backupOrginlDrctry" size="60" maxlength="255" />
  	...
  	<tr>
    	...
    	<td>
        	<form:input path="backupStreDrctry" size="60" maxlength="255" />
...
function fn_aram_insert(){
	...
	if(confirm("<spring:message code='common.regist.msg'/>")){
        varForm.action = "${pageContext.request.contextPath}/sym/sym/bak/insertBackupOpert.do";
        varForm.submit();
    }
}
