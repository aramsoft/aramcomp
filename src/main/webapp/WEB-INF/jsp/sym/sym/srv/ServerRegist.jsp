...
<%
/**
 * @Class Name : ServerRegist.jsp
 * @Description : 서버S/W 등록
...
<!-- 등록  폼 영역  -->
<form:form modelAttribute="serverVO" action="" method="post">
<input type="hidden" name="curTrgetId" value="${curTrgetId}" />
<input type="hidden" name="curMenuNo" value="${curMenuNo}" />

<table class="table-register" summary="서버S/W를 등록한다.">
...
function fn_aram_insert() {
	...
	if(confirm("<spring:message code='common.regist.msg'/>")){
        varForm.action = "${pageContext.request.contextPath}/sym/sym/srv/insertServer.do";
        varForm.submit();
    }
}
