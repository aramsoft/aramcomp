...
<%
/**
 * @Class Name : MtgPlaceResveRegist.jsp
 * @Description : 회의실예약 신청
...
<form:form modelAttribute="mtgPlaceResveVO" method="post" action="">
...
<table class="table-register" summary="회의실예약관리 등록">
<caption>회의실예약관리 등록</caption>
  	...
  	<tr>
    	...
    	<td colspan="3">
      		<form:textarea path="mtgCn" rows="4" cols="70" cssClass="txArea" title="회의내용"/>
      		<form:errors path="mtgCn" cssClass="error"/>
    	</td>
  	</tr>
</table>
...
function fn_aram_insert() {
	...
	if(confirm("<spring:message code='common.regist.msg'/>")){
		varForm.action = "${pageContext.request.contextPath}/uss/ion/mtg/insertMtgPlaceResve.do";
		varForm.submit();
	}
}
...
function fn_aram_dplact_check(){
	...
	if((endTm-beginTm)> 0){
	    ...
	    var sTempValue = "sTmResveDe="+varForm.resveDe.value+"&sTmResveBeginTm="+varForm.resveBeginTm.value+"&sTmResveEndTm="+varForm.resveEndTm.value+"&sTmMtgPlaceId="+varForm.mtgPlaceId.value+"&sTmResveId=";
