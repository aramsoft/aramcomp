...
<table class="table-register">
  	...
  	<tr>
    	...
    	<td>
        	...
        	<span style="cursor:pointer;" onclick="showColorTable(); return false;"><img src="${pageContext.request.contextPath}/images/uss/mpe/icon/cIcon.gif" alt="색상표아이콘" width="16" height="16" border="2" style="vertical-align: middle"></span>
