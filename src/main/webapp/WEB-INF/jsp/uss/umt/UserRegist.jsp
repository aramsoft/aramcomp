...
<table class="table-register">
    <tr>
        ...
        <td width="80%">
            ...
            <a href="#" onclick="fn_aram_idCheck(); return false;">
                <img src="${pageContext.request.contextPath}/images/cmm/icon/search.gif" alt="" />(중복아이디 검색)
            </a>
    ...
    <tr>
        ...
        <td>
            <form:input path="homeadres" title="주소" size="60" maxlength="60" />
    ...
    <tr>
        ...
        <td>
            ...
            <a href="#" onclick="fn_aram_detail_cert(); return false;" style="selector-dummy: expression(this.hideFocus=false);">
            	<img src="${pageContext.request.contextPath}/images/cmm/icon/search.gif"	width="15" height="15" alt="search"/>
            </a>
